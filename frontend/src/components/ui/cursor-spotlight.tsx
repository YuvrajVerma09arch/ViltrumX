...
/**
 * Mouse-following glow (ibelick spotlight, renamed to avoid clashing with the
 * entrance Spotlight). Attaches to its parent element; gradient stops default
 * to the ViltrumX accent since cn() here has no tailwind-merge to resolve
 * conflicting gradient-stop overrides.
 */
